...
Script Objective:
This stored procedure executes the full data refinement pipeline by transferring records from the 'bronze' layer to the 'silver' layer.

Key Operations:
-Clears existing content from 'silver' tables to ensure a fresh load.
-Loads curated and standardized data extracted from 'bronze' sources
		
Usage Example:
    EXEC silverLayer.load_silverLayer;
===============================================================================
*/
EXEC dbo.bronzeLayer_load_bronzeLayer
EXEC silverLayer.load_silverLayer
CREATE OR ALTER PROCEDURE silverLayer.load_silverLayer AS
BEGIN
    ...
    BEGIN TRY
        ...
        SET @start_time = GETDATE();
		PRINT '>> Truncating Table: silverLayer.erp_cust_az12';
		TRUNCATE TABLE silverLayer.erp_cust_az12;
		PRINT '>> Inserting Data Into: silverLayer.erp_cust_az12';
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Table: silverLayer.erp_px_cat_g1v2';
		TRUNCATE TABLE silverLayer.erp_px_cat_g1v2;
		PRINT '>> Inserting Data Into: silverLayer.erp_px_cat_g1v2';
